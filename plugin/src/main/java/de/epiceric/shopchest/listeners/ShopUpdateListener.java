...
public class ShopUpdateListener implements Listener {
    ...
    public void onInventoryUpdate(InventoryMoveItemEvent e) {
        ...
        if (e.getSource().getHolder() instanceof Chest || e.getSource().getHolder() instanceof Barrel || e.getSource().getHolder() instanceof ShulkerBox) {
        ...
        } else if (e.getDestination().getHolder() instanceof Chest || e.getDestination().getHolder() instanceof Barrel || e.getDestination().getHolder() instanceof ShulkerBox){
